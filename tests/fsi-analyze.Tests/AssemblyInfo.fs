...
[<assembly: AssemblyTitleAttribute("fsi-analyze.Tests")>]
[<assembly: AssemblyProductAttribute("fsi-analyze")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "fsi-analyze.Tests"
    let [<Literal>] AssemblyProduct = "fsi-analyze"
